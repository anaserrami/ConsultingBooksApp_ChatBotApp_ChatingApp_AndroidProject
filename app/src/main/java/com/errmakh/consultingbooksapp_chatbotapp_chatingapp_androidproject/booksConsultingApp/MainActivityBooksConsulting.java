...
import com.errmakh.consultingbooksapp_chatbotapp_chatingapp_androidproject.booksConsultingApp.activities.BookDetailActivity;
import com.errmakh.consultingbooksapp_chatbotapp_chatingapp_androidproject.booksConsultingApp.adapters.BookAdapter;
...
public class MainActivityBooksConsulting extends AppCompatActivity {
        ...
        buttonSearch.setOnClickListener(view -> {
            ...
            call.enqueue(new Callback<GoogleBooksResponse>() {
                ...
                public void onFailure(Call<GoogleBooksResponse> call, Throwable throwable) {
                    ...
                    Log.i("Info", "nop");
                    Toast.makeText(MainActivityBooksConsulting.this, "Connection Error", Toast.LENGTH_SHORT);
                }
            });
        });
